PROGRAM Memory_Leak
!--------------------------------------
! Program to illustrate a memory leak.
! The programmer should  try to  avoid
! this kind of situation!
!
! The program  calculates  the mean of
! the integer numbers  between 1 and n 
! up to n=100000.  The program however
! includes a memory leak and soon runs
! out of memory.
!--------------------------------------
  IMPLICIT NONE
  ...
  DO i=1,100000
    ...
    NULLIFY(p) ! memory leaks occur here!
