...
! The output is sent to a new file
! called stresses.out
!----------------------------------  
  ...
  WRITE(3,30) "normal stress by force  =", N_Stress_f, " Pa"  
  WRITE(3,30) "normal stress by moment =", N_Stress_m, " Pa"  
  WRITE(3,30) " shear stress by torque =", S_Stress,   " Pa"  
  30 FORMAT(A,F10.2,A)
