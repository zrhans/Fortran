 ...
 !    sib%prog%tg = sib%prog%tg + sib_loc%dtg
     ...
     if ( sib%prog%tc < 0.0 .or. sib%prog%td(sib%prog%nsl+1) < 0.0 .or.  &
         sib%prog%ta < 0.0 .or. sib%prog%ea < 0.0 ) then
 
         print *, 'point',sib%stat%pt_num
         print *, 'BAD ta, tg, tc or ea VALUE:'
         print *, 'tc: ', sib%prog%tc-sib_loc%dtc, sib%prog%tc
         print *, 'tg: ', sib%prog%td(sib%prog%nsl+1)-sib_loc%dtd(sib%prog%nsl+1), sib%prog%td(sib%prog%nsl+1)
