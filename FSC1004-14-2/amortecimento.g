...
y(x)=ym*exp((-1/k)*x)*sin(w*x)
e(x) = exp((-1./k)*x)
y1(x)=ym*exp((-1./k1)*x)*sin(w*x)
y2(x)=ym*exp((-1./k2)*x)*sin(w*x)
y3(x)=ym*exp((-1./k3)*x)*sin(w*x)
GNUTERM = "wxt"
ym = 1
k = 1000
w = 5
GPFUN_y = "y(x)=ym*exp((-1/k)*x)*sin(w*x)"
GPFUN_e = "e(x) = exp((-1./k)*x)"
k1 = 5
GPFUN_y1 = "y1(x)=ym*exp((-1./k1)*x)*sin(w*x)"
k2 = 2
GPFUN_y2 = "y2(x)=ym*exp((-1./k2)*x)*sin(w*x)"
k3 = 0.5
GPFUN_y3 = "y3(x)=ym*exp((-1./k3)*x)*sin(w*x)"
b = 9.8
g = 9.8
m = 1
l = 1
p[0:4*pi] ym*exp(-(1/k)*x)*sin(w*x) , y1(x),y2(x),y3(x)
#    EOF