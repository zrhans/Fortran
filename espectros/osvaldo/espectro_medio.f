...
C
      OPEN(UNIT=11,FILE='SWs6b.DAT',STATUS='UNKNOWN')
      DO 10 I=1,NN
      READ (11,*,END=10)(INPUT(I,J),J=1,32)
10    CONTINUE 
C
      PRINT*,'LEU O ARQUIVO'
C
...
C
c
      CALL BANDAS(freqad,suad,HZMEAN,SPECUMEAN)
      CALL BANDAS(freqad,sVad,HZMEAN,SPECVMEAN)
      CALL BANDAS(freqad,sWad,HZMEAN,SPECWMEAN)
c
C
          DO I=1,M
