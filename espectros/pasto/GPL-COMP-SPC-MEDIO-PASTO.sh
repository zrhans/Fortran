...
set xlabel "f=nz/U"
plot[][0.1:10000] '$data/$nome' u 1:2 t '$tipo' w lp $point,'$data/$filecomp' u 1:2 t '$tipoN' w l 
...
set ylabel "nS_{u}/u@^{2}_* {/Symbol f}^{2/3}"
set xlabel "f=nz/U"
plot[][0.1:10000] '$data/$nome16' u 1:2 t '$tipo16' w lp $point,'$data/$filecomp16' u 1:2 t '$tipoN16' w l  
...
set xlabel "f=nz/U"
plot[][0.1:10000] '$data/$nome' u 1:3 t '$tipo' w lp $point,'$data/$filecomp' u 1:3 t '$tipoN' w l  
...
set ylabel "nS_{v}/u@^{2}_* {/Symbol f}^{2/3}"
set xlabel "f=nz/U"
plot[][0.1:10000] '$data/$nome16' u 1:3 t '$tipo16' w lp $point,'$data/$filecomp16' u 1:3 t '$tipoN16' w l  
...
set xlabel "f=nz/U"
plot[][0.1:10000] '$data/$nome' u 1:4 t '$tipo' w lp $point,'$data/$filecomp' u 1:4 t '$tipoN' w l  
...
set ylabel "nS_{w}/u@^{2}_* {/Symbol f}^{2/3}"
set xlabel "f=nz/U"
plot[][0.1:10000] '$data/$nome16' u 1:4 t '$tipo16' w lp $point,'$data/$filecomp16' u 1:4 t '$tipoN16' w l  
unset multiplot
endGPL_script
