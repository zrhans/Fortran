...
c	PARAMETER(N=32768,NN=846000,KK=3600,K=16384,M=44,MNN=12,FDRACTIVE=1,TR=350.0,)
	PARAMETER(N=2**16,NN=870000,KK=1800,K=N/2,M=45,MNN=12,FDRACTIVE=1,TR=350.0)
...
c
	if (FDRACTIVE.EQ.1) THEN
C	ccccccccccccccccccccccccc inicio hans
C	C CALCULA AS COMPONENTES TURBULENTAS apos remocao linear de tendencia
C
	DO 6023 I=1,N
...
C       subtraido da serie (NESTE CASO JÁ ROTADA PARA U,V E W [NNINPUT(I,J)]).
 	DO 66010 I=1,N
