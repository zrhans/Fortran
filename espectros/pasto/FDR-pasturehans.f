...
!	if (kturb.lt.3601) print*,'entrando em BADAS',kturb
	CALL BANDAS(HHERTZ,SSPCW,HZwS,WSMOOTH,K,M+1)
	CALL BANDAS(HHERTZ,SSPCT,HZtS,TSMOOTH,K,M+1)
	CALL BANDAS(HHERTZ,SSPCU,HZuS,USMOOTH,K,M+1)
	CALL BANDAS(HHERTZ,SSPCV,HZvS,VSMOOTH,K,M+1)
	CALL BANDAS(HHERTZ,SSPCQ,HZqS,QSMOOTH,K,M+1)
	CALL BANDAS(HHERTZ,SSPCC,HZqS,CSMOOTH,K,M+1)
	CALL BANDAS(HHERTZ,CCOT,HZwtC,WTSMOOTH,K,M+1)
	CALL BANDAS(HHERTZ,CCOC,HZwcC,WCSMOOTH,K,M+1)
	CALL BANDAS(HHERTZ,CCOQ,HZwqC,WQSMOOTH,K,M+1)
