...
<input type="button" name="stop" value="Stop" />
 ...
 2005. NESTA ULTIMA VERSAO FORAM INCORPORADAS AS      C
...
c	PARAMETER(N=32768,NN=846000,KK=3600,K=16384,M=44,MNN=12)
	PARAMETER(N=2**14,NN=870000,KK=1800,K=N/2,M=45,MNN=12)
...
! cria o arquivo US de acordo com a classe
