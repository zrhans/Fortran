PROGRAM mruv
      ...
      END DO
      STOP
	  ! essa equacao se declarava variavel (V) indefinida  
	  ! este era o erro deste programa para corrigir o programa 
	  ! substitui na equacao a variavel indefinida pela variavael declarada (v0)
END PROGRAM mruv
